...
<body>
    ...
    <%
		...
		graphlist =(ArrayList<graphBean>)request.getSession().getAttribute("graphlist");
		for(int i = 0; i < graphlist.size(); i ++){
			graphBean graphBean = graphlist.get(i);
			json.put("subject", graphBean.getSubject());
			json.put("Predicate", graphBean.getPredicate());
			json.put("Object", graphBean.getObject());
			jsonArray.put(json);
		}
		
	%>
    <div style="displat:none" id="jsonData"><%=jsonArray%>></div>
</body>
    <script src="js/jquery-3.2.1.min.js"></script>
    <script src="echarts.min.js"></script>
    <script type="text/javascript">
    var Arrt = new Array();
    var String=document.getElementById('jsonData');
